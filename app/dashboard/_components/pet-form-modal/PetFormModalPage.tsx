...
//   return (
//     <div className="m-auto self-start">
//       <div className="fixed inset-0 bg-black/40 z-50 flex overflow-auto">
//         <div className="w-[1000px] bg-gray-100 rounded-md shadow-lg mx-auto my-auto self-start overflow-x-auto overflow-y-auto">
//           {" "}
//           {/* ========= NAVBAR ========= */}
//           <div className="w-full">
//             <Navbar>Nueva Mascota...</Navbar>
