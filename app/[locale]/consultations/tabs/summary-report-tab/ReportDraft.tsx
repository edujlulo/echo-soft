    ...
    <>
      <div className="-mt-2 px-2 flex flex-col gap-1 items-start relative">
        ...
        <textarea
          ...
          readOnly={!isEditable}
          className="w-[700px] h-[560px] text-base bg-white border border-blue-200 px-2 pb-0.5 pt-1.5 rounded focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500 focus:bg-white"
        />
        {isEditable ? (
